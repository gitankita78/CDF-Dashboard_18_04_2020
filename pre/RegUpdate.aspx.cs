...
public partial class RegUpdate : System.Web.UI.Page
{
    ...
    protected void ddl_married_status_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (ddl_married_status.SelectedValue== "Divorce"|| ddl_married_status.SelectedValue == "Widow" || ddl_married_status.SelectedValue == "Widower")
        {
            div_married.Visible = true;
            txt_spouse.ReadOnly = true;
             txt_spouse.Text = "";
