       ...
       <%--  <div id="loaderDiv" class="loading" style="text-align:center">
        ...
        <div class="col-md-12 col-sm-10 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">                 
                     <asp:Label ID="NoSesFound" ForeColor="Red" runat="server" Text=""></asp:Label>  
                    <div style="overflow-x:scroll;">                  
                    <asp:GridView ID="Gridmysession" runat="server" AutoGenerateColumns="False" CellPadding="10"                                               
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ShadowMob" HeaderText="Shadow Contact" SortExpression="ShadowMob" />


                             <asp:BoundField DataField="ConductingCDF" HeaderText="Conducting CDF " SortExpression="ConductingCDF" />

                            <asp:BoundField DataField="CDFMOb" HeaderText="CDF Contact" SortExpression="CDFMOb" />
                            ...
                            <%--<asp:BoundField DataField="SesAddress" HeaderText="Session Address"  ItemStyle-Width="50px" ItemStyle-Wrap="true"
                                SortExpression="SesAddress" />--%>

                            <asp:TemplateField HeaderText="Session Address">
                                  <ItemTemplate>
                                      <div style="width:300px; overflow: hidden; line-break:normal">
                          ...
                          <%--   <asp:TemplateField  HeaderText="Session OTP" >
                           ...
                           <%--  <asp:HyperLink ID="hlView"  ToolTip="View Graph"  OnClick="myfunction"  ForeColor="DarkBlue"  runat="server" NavigateUrl='<%# Eval("StudId", "~/Graph_Report/ViewGrah_Scheduling.aspx?StudId={0}") %>'>View</asp:HyperLink>--%>
                              ...
                              <%--<asp:LinkButton ID="LinkEditLine" ToolTip="View Graph"  ForeColor="DarkBlue" runat="server" Text="View" NavigateUrl='<%# Eval("StudId", "~/Graph_Report/ViewGrah_Scheduling.aspx?StudId={0}") %>'/>--%>                               
                                   ...
                                   <ContentTemplate>  
                                       <%--<a href='http://localhost:8478//Candidate/ViewGraph.aspx?c_id=<%# Eval("StudId")%>' target="_blank" class="btn btn-default" >View Graph</a> --%>
               ...
               <div style="overflow-x:scroll;">
                    <asp:GridView ID="dtl" runat="server" AutoGenerateColumns="False"  HeaderStyle-CssClass="header"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Session Address">
                                  <ItemTemplate>
                                      <div style="width:200px; overflow: hidden; line-break:normal">
                      ...
                      <asp:TemplateField HeaderText="Report">
                           ...
                           <asp:TemplateField HeaderText="FeedBack" Visible="false">
                            <ItemTemplate> 
                             ...
                             <ContentTemplate> 
                              <asp:Button ID="btnfeedback" ToolTip="View Feedback" CommandArgument='<%# Eval("StudId")%>' CommandName="feedback" runat="server" Text="FeedBack" Visible="false"/>
                             </ContentTemplate>                                  
                             </asp:UpdatePanel> 
                            </ItemTemplate>
                        </asp:TemplateField>                                          
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td ><asp:Image ID="star1" runat="server" ImageUrl="~/images/Star/a.jpg" style="width:79px; margin:-48px" />
                                                                          <asp:Image ID="star2" runat="server" ImageUrl="~/images/Star/b.jpg" style="width:79px; margin:-48px" />
                                                                          <asp:Image ID="star3" runat="server" ImageUrl="~/images/Star/c.jpg" style="width:79px; margin:-48px" />
                                                                          <asp:Image ID="star4" runat="server" ImageUrl="~/images/Star/d.jpg" style="width:79px; margin:-48px" />
                                                                          <asp:Image ID="star5" runat="server" ImageUrl="~/images/Star/e.jpg" style="width:79px; margin:-48px" />
                                                                      </td>
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td ><asp:Image ID="Image1" runat="server" ImageUrl="~/images/Star/1a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image2" runat="server" ImageUrl="~/images/Star/2a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image3" runat="server" ImageUrl="~/images/Star/3a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image4" runat="server" ImageUrl="~/images/Star/4a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image5" runat="server" ImageUrl="~/images/Star/5a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image6" runat="server" ImageUrl="~/images/Star/6a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image7" runat="server" ImageUrl="~/images/Star/7a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image8" runat="server" ImageUrl="~/images/Star/8a.jpg" style="width:132px; margin:-48px" />
                                                                          <asp:Image ID="Image9" runat="server" ImageUrl="~/images/Star/9a.jpg" style="width:132px; margin:-48px" />
                                                                      </td>
