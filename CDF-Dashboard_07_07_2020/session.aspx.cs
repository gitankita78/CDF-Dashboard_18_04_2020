...
public partial class session : System.Web.UI.Page
{
    ...
    public void counter_session()
    {
        try
        {
            using (SqlConnection con = new SqlConnection(connStr))
            {
                ...
                SqlCommand cmd = new SqlCommand("cdfdetails_maintest", con);
    ...
    public void lblGrid()
    {
        try
        {
            using (SqlConnection con = new SqlConnection(connStr))
            {
                // SqlCommand cmd = new SqlCommand("sp_cdfdetails1", con); cdfdetails_maintest
                SqlCommand cmd = new SqlCommand("cdfdetails_maintest", con);
                cmd.CommandType = CommandType.StoredProcedure;
                int uid = Convert.ToInt32(HttpContext.Current.Session["uid"]);
               ...
               var shadowAcceptance = ds.Rows[0]["shadowacceptance"].ToString();
                ...
                else if (role == "ShadowCDF")
                {
                      if (shadowAcceptance == "")
                    {
                        ...
                        Gridmysession.Columns[23].Visible = false;
                    }
                    if(shadowAcceptance == "True")
                    {
                        Gridmysession.Columns[21].Visible = false; //otp
                        Gridmysession.Columns[22].Visible = true; //graph
                ...
                if (sdr.HasRows)
                {
                    Gridmysession.Columns[17].Visible = false;
    ...
    protected void Gridmysession_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string asd = e.Row.Cells[20].Text;
            ...
            if (e.Row.Cells[20].Text == "Accepted")
            {
                //e.Row.Cells[13].BackColor = Color.Green ;
            
                e.Row.Cells[20].ForeColor = Color.Green;
            ...
            if (e.Row.Cells[20].Text == "Rejected")
            {
                //e.Row.Cells[13].BackColor = Color.White;
    ...
    protected void Gridmysession_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
                ...
                using (SqlConnection con = new SqlConnection(connStr))
                {
                    ...
                    con.Close();
                        if (i > 0)
                        {
                            ...
                            //CanM.c_first_name +' '+ CanM.c_last_name as CandName ,CanM.c_gender as CandGender, CanM.c_email_id as CandEmail, CanM.c_phone_no as CandContact
                            //string query = " select fname,lname,contactNo,email from tbl_candidate_master where id='" + studentId + "'";

                            string query = " select c_first_name as fname,c_last_name as lname,c_phone_no as contactNo,c_email_id as email from [cyberind_dheya].[dbo].[tbl_candidate_master] where c_id='" + studentId + "'";
            ...
            case "report": 
                ...
                Response.Redirect("~/Graph_Report/Half_Report_By_RAPD1_maintest.aspx?c_id=" + c_id + "");
                //*************************************************************
                ////  SqlCommand cm = new SqlCommand("select batid from tblKYCandFactors1 where c_id='" + stud1 + "'");
                //SqlCommand cm = new SqlCommand("select prodM.batid from tblCandidateProductMaster as candM left join tblProductMaster as prodM on candM.prodid=prodM.pId where cid='" + stud1 + "'");
                //cm.Connection = con11;
            ...
            case "graph":
               ...
               // ScriptManager.RegisterStartupScript(this, this.GetType(),"loaderPopup", "openloader();", true);
                ...
                Response.Redirect("~/Graph_Report/ViewGraph_new.aspx?c_id=" + studID);
                break;
            ...
            case "feedback":
                ...
                using (SqlConnection con = new SqlConnection(connStr))
                {
                    ...
                    {                       
                        ...
                        if (dt.Tables[0].Rows[4]["AnsText"].ToString() == "1")
                        {
                            star1.Visible = true;
                            star2.Visible = false;
                            star3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[4]["AnsText"].ToString() == "3")
                        {
                            star1.Visible = false;
                            star2.Visible = false;
                            star3.Visible = true;
                        ...
                        if (dt.Tables[0].Rows[4]["AnsText"].ToString() == "4")
                        {
                            star1.Visible = false;
                            star2.Visible = false;
                            star3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[4]["AnsText"].ToString() == "5")
                        {
                            star1.Visible = false;
                            star2.Visible = false;
                            star3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "1")
                        {
                            Image1.Visible = true;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "2")
                        {
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "3")
                        {
                            Image1.Visible = false;
                            Image2.Visible = false;
                            Image3.Visible = true;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "4")
                        {
                            Image1.Visible = false;
                            Image2.Visible = false;
                            Image3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "5")
                        {
                            Image1.Visible = false;
                            Image2.Visible = false;
                            Image3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "6")
                        {
                            Image1.Visible = false;
                            Image2.Visible = false;
                            Image3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "7")
                        {
                            Image1.Visible = false;
                            Image2.Visible = false;
                            Image3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "8")
                        {
                            Image1.Visible = false;
                            Image2.Visible = false;
                            Image3.Visible = false;
                        ...
                        if (dt.Tables[0].Rows[5]["AnsText"].ToString() == "9")
                        {
                            Image1.Visible = false;
                            Image2.Visible = false;
                            Image3.Visible = false;
