<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Executive/executive-master.master" AutoEventWireup="true" CodeFile="candidate-list.aspx.cs" Inherits="Admin_Executive_candidate_list" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="More Details">
                                <ItemTemplate>
                                    <asp:HyperLink ID="Details" Target="_blank" runat="server" NavigateUrl='<%# Eval("id", "candidate-details.aspx?id={0}") %>'
