//********************************************************************************************
//PageName        : Details   
//Description     : This page is display User details to excetive(only view cdf info and graph and report)
//AddedBy         : Ankita                   AddedOn   : 14/04/2020
//UpdatedBy       :                            UpdatedOn : 
//Reason          :
//*******************************************************************************************
...
public partial class Admin_Executive_candidate_details : System.Web.UI.Page
{
    ...
    private void load_nda()
    {
        try
        {
            ...
            //PdfStamper pdfStamper = new PdfStamper(pdfReader, new FileStream(Server.MapPath("~") + "/doc/Admin-NDA/" + hid_fileName.Value.ToString()));
