<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Executive/executive-master.master" AutoEventWireup="true" CodeFile="candidate-details.aspx.cs" Inherits="Admin_Executive_candidate_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form runat="server">
        ...
        <div class="row">
            <%--User status--%>
            <div class="col-sm-6" id="div_ustatus" runat="server" visible="false">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>User Status</h2>
        ...
        <%--User Requirements--%>
        <div class="x_panel" id="div_req" runat="server" visible="false">
            <div class="x_title">
        ...
        <%--Payment Details--%>
        <div class="x_panel" id="div_upayment" runat="server" visible="false">
            <div class="x_title">
        ...
        <div class="x_panel" id="div3" runat="server" visible="false">
            <div class="x_title">
        ...
        <div class="x_panel" id="div4" runat="server" visible="false">
            <div class="x_title">
        ...
        <div class="x_panel" id="div8" runat="server" style="margin-bottom: 80px;" visible="false">
            <div class="x_title">
                <h2>Dheya Updates</h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a href="#" data-toggle="modal" title="Help" data-target="#myModalHelpRequirements"><i class="fa fa-question"></i></a>
