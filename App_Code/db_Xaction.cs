...
public class db_Xaction
{
    ...
    public db_Xaction()
    {
        ...
        strcon1 = ConfigurationManager.ConnectionStrings["career_portalConnectionString"].ConnectionString.ToString();
        //
    ...
    //********************************************************************************************
    //FunctionName    : ExecDataSet_maintest
    //InputParameter  : s_query
    //returnValue     : DataSet dr
    //Description     : Function Call When User Read The information from database in DisConnected 
    //					function return DataSet for cyberind_dheya connection string for main test report-graph
    //*******************************************************************************************

    public DataSet ExecDataSet_maintest(string s_query)
    {
        // Call function  ConOpen for Open the Database Connection
    ...
    //********************************************************************************************
    //FunctionName    : ExecDataReader_maintest
    //InputParameter  : s_query
    ...
    public SqlDataReader ExecDataReader_maintest(string s_query)
    {
        // Call function  ConOpen for Open the Database Connection
        ConOpen1();
...
//********************************************************************************************
    ...
    //********************************************************************************************
    //FunctionName    : ConOpen1
    //InputParameter  : none
    //returnValue     : none
    //Description     : Function Call When User Want to open the database connection for cyberind_dheya
    //AddedBy         : Ankita                      AddedOn   : 09/03/2020
    //UpdatedBy       :                            UpdatedOn :
    //Reason          :
    //*******************************************************************************************
    ...
    //Main Test Graph call ViewGrapf_new both Get_values and set_values
    public int get_values_maintest(int Cand_id)
    {
        string strcmd = "Select * FROM Cand_PD_Details where c_id= '" + Cand_id + "'";
        dr = ExecDataReader_maintest(strcmd);
        while (dr.Read())
        {
            ...
            //code_m = dr.GetString(5);
            //code_l = dr.GetString(6);
            code_m = dr.GetString(4);
            code_l = dr.GetString(5);
            switch (code_m)
            {
                case "Bl":
                    BLACKM = BLACKM + 1;
